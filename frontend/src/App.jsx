...
function App() {
    ...
    return (
        <div className="min-h-screen pb-10 bg-slate-950 relative overflow-hidden z-0">
            ...
            <div className={`px-4 pt-6 sticky ${isPaused && account ? 'top-12' : 'top-0'} z-40`}>
                <header className="max-w-6xl mx-auto glass rounded-2xl border border-slate-700/50 shadow-xl">
                    <div className="px-6 py-3 flex flex-col sm:flex-row items-center justify-between gap-4">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h1 className="text-xl font-bold text-white tracking-wide drop-shadow-md">IkkyToken</h1>
                                <p className="text-xs text-cyan-400 font-mono tracking-widest uppercase">Decentralized Asset</p>
                            </div>
                        </div>
                    <ConnectWallet
                        account={account}
                ...
                {!account ? (
                    ...
                    <div className="py-12 animate-slide-down-fade">
                        ...
                        <div className="text-center mb-16">
                            ...
                            <div className="inline-block bg-slate-800/50 border border-primary-500/30 rounded-full px-6 py-3 animate-pulse">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                            {/* Card 1 */}
                            <div className="card hover:-translate-y-2 transition-transform duration-300 border-t-4 border-t-blue-500 bg-slate-900/80 text-center">
                                ...
                                <h3 className="text-xl font-bold text-white mb-3">Apa itu Crypto & Web3?</h3>
                            ...
                            {/* Card 2 */}
                            <div className="card hover:-translate-y-2 transition-transform duration-300 border-t-4 border-t-purple-500 bg-slate-900/80 text-center">
                                ...
                                <h3 className="text-xl font-bold text-white mb-3">Standar Token ERC-20</h3>
                                <p className="text-slate-400 text-sm leading-relaxed">
                            ...
                            {/* Card 3 */}
                            <div className="card hover:-translate-y-2 transition-transform duration-300 border-t-4 border-t-green-500 bg-slate-900/80 text-center">
                                ...
                                <h3 className="text-xl font-bold text-white mb-3">Fokus Skripsi</h3>
                                <p className="text-slate-400 text-sm leading-relaxed">
                                    DApp ini mendemonstrasikan pentingnya <strong>Desentralisasi Penuh</strong>. Melalui fitur <code className="text-xs bg-slate-800 px-1 py-0.5 rounded text-green-400">Renounce Ownership</code>, <strong>developer</strong> dapat menghilangkan fungsi-fungsi kritis yang mereka miliki secara permanen (seperti fungsi <span className="text-primary-400 font-semibold">Minting</span>, <span className="text-red-400 font-semibold">Blacklisting</span>, dan <span className="text-yellow-400 font-semibold">Pausing</span>). Hal ini memastikan bahwa tidak ada lagi otoritas terpusat yang bisa menyalahgunakan wewenang secara sepihak terhadap aset pengguna.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="max-w-4xl mx-auto mt-24 text-center">
                            <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">Kenali Lebih Dalam Tentang Web3</h2>
                            <p className="text-slate-400 mb-8 max-w-2xl mx-auto">
                                Pelajari bagaimana teknologi desentralisasi mengubah masa depan internet dan keuangan digital di seluruh dunia.
                            </p>
                            <div className="relative w-full overflow-hidden rounded-2xl shadow-[0_0_40px_rgba(56,189,248,0.15)] border border-slate-700/50 bg-slate-900/50 pt-[56.25%] group">
                                <iframe 
                        ...
                        <div className="max-w-4xl mx-auto mt-20 mb-10 text-left">
                            <h2 className="text-2xl md:text-3xl font-bold text-white mb-2 text-center">Pertanyaan Investor (FAQ)</h2>
                            ...
                            <div className="space-y-4">
                                <details className="group bg-slate-900/80 border border-slate-700/50 rounded-xl overflow-hidden cursor-pointer shadow-lg">
                                    <summary className="font-bold text-lg text-white p-5 flex justify-between items-center bg-slate-800/50 hover:bg-slate-700/50 transition-colors">
                                    ...
                                    <div className="p-5 text-slate-400 leading-relaxed border-t border-slate-700/50 bg-slate-900/50">
                                ...
                                <details className="group bg-slate-900/80 border border-slate-700/50 rounded-xl overflow-hidden cursor-pointer shadow-lg">
                                    ...
                                    <div className="p-5 text-slate-400 leading-relaxed border-t border-slate-700/50 bg-slate-900/50">
                                        IkkyToken menyediakan fitur <strong className="text-green-400">Renounce Ownership</strong>. Saat fitur ini ditekan, developer melepaskan seluruh hak akses khusus mereka secara permanen (<em>irreversible</em>). Kontrak pintar (<em>smart contract</em>) menjadi 100% mandiri dan berjalan otomatis di blockchain tanpa ada siapa pun yang bisa mengubah aturannya atau membekukan dana pengguna lagi.
                                    </div>
                                </details>
                            </div>
                        </div>
            ...
            <footer className="mt-20 pb-8 px-4">
                <div className="max-w-6xl mx-auto glass rounded-xl border border-slate-700/50 p-6 flex flex-col md:flex-row justify-between items-center gap-6 text-sm text-slate-300 shadow-lg relative overflow-hidden">
                    {/* Glowing Top Border */}
                    ...
                    <div className="flex items-center gap-3 bg-slate-900/80 px-4 py-2 rounded-full border border-slate-600">
                    ...
                    <div className="text-center md:text-right">
                        <p className="font-bold text-white text-base tracking-wide">IkkyToken DApp <span className="text-cyan-400 ml-1 text-sm font-mono bg-cyan-900/30 px-2 py-0.5 rounded">v1.0</span></p>
                        <p className="mt-2 text-slate-400 font-medium">Fokus Skripsi: Pencegahan Kontrol Sentralistik pada Token ERC-20</p>
                    </div>
                </div>
            </footer>
        </div>
